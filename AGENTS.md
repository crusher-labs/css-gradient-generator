...
Single-purpose static tool: Visually create, customize, and copy CSS linear or radial gradients. Part of the crusher-labs **static tools line** (frozen). Hosted on GitHub Pages at https://crusher-labs.github.io/css-gradient-generator/
